...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_105_ansi(
        ...
        KC_P4,    KC_P5,    KC_P6,               KC_LCTL,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,               KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,  KC_ENT,             KC_HOME,
        KC_P1,    KC_P2,    KC_P3,    KC_PENT,   KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_ESC,   KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,  KC_UP,
        KC_P0,              KC_PDOT,             KC_LCTL,  KC_LOPTN,           KC_LCMMD,           KC_SPC,   LCMD(KC_SPC),       KC_BSPC,            KC_MEH,   KC_RCTL,            KC_LEFT,  KC_DOWN,  KC_RGHT),
